        ...
        <Container className="bg-light"  >
            ...
            <Form noValidate validated={validado} onSubmit={manipulaSubmissao}>
                ...
                <Row>
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Select aria-label="Default select example"
                                value={usuario.treinador} id="treinador"
                                onChange={manipulaEvento}>
                                <option null >Selecione uma opção</option>
                    ...
                    <Col>
                        <Form.Group>
                            ...
                            <Form.Select aria-label="Default select example"
                                value={usuario.jogador} id="jogador"
                                onChange={manipulaEvento}>
                                <option null>Selecione uma opção</option>
                                <option value="Sim">Sim</option>
                                <option value="Não">Não</option>
                ...
                <>
                    ...
                    <Button type="button" variant="danger" onClick={() => { props.exibirTabela(true) }}>Voltar</Button>
                </>
            </Form>
